---
title: "Recruitment Deviations Check"
output: md_document
---
...
## Questions
- Does the constrained normal distribution help EM gets accurate estimates? 

- Does the OM need to simulate data that exactly satisfy a set of constraints?

  - `mvrnorm` from `MASS` in R allows you to simulate multivariate normal data with a pre-specified sample mean and covariance by setting `empirical=TRUE` 
  
- Where are the source code of constrained normal distribution in ADMB?

  - ADMB code to generate random numbers: [Page 7](https://www.admb-project.org/courses/previous/july-2009/DataInOut.pdf)
